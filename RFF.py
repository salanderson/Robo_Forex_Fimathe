    ...
    while True:
        ...
        if estado_ordem == "aguardando_venda":
            if tick.bid <= config['preco_venda']:
                resultado = enviar_ordem(ativo, "sell", config['volume'], tick.bid, config['tp_veda'])
